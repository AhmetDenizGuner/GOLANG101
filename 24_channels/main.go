...
//GO'da return olan bir fonksiyon/method go routine ile çağrılamaz. Bu problemi çzömek için channel kullanılır.
//chanell başka bir go routine onu çağrına kadar diğer rutinleri blokluyor.
